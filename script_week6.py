...
#model_SVC = SVC(C=10, kernel='poly')
model_SVC = LinearSVC(C=10, loss="hinge")

model_SVC.fit( X_train_flat, new_y_train)
...
pickle.dump(model_SVC, open('linear_svm_poly.pkl', 'wb'))
